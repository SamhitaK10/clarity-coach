...
import llamaHeadsetImage from "figma:asset/ba3f08758491f6b17708870b4e0ceee5f6152335.png";
import llamaCameraSmallImage from "figma:asset/df8b75e5a357924574150d9137867e0cc6eadcdf.png";
import llamaClipboardImage from "figma:asset/b9e05bd423916514c179c0fe1090521fe09dab99.png";
import llamaClockImage from "figma:asset/9757c4949b5c9226535773cf58040d9db20d94bc.png";
        ...
        <div className="max-w-[1200px] mx-auto space-y-20">
                ...
                >
                  <svg className="absolute inset-0" viewBox="0 0 280 280" style={{ transform: 'rotate(-90deg)' }}>
                    ...
                    <circle
                      ...
                      strokeDashoffset={`${2 * Math.PI * 130 * (1 - mockResults.overallScore / 100)}`}
                      strokeLinecap="round"
                    />
                  </svg>
          ...
          >
            ...
            <div className="prose max-w-none">
              ...
              >
                {mockResults.transcript.map((segment, index) => (
                  <span
                    key={index}
          ...
          >
            ...
            <div>
              ...
              <div className="space-y-4">
                {mockResults.strongMoments.map((moment, index) => (
                  <TimestampCard
                    key={index}
                    type="strong"
            ...
            <div>
              ...
              <div className="space-y-4">
                {mockResults.areasToImprove.map((moment, index) => (
                  <TimestampCard
                    key={index}
                    type="improve"
                    timestamp={moment.timestamp}
